"""
Agentic RAG API endpoints using OpenAI Assistants.
This module provides the new agent-based document search API while maintaining 
backward compatibility with the existing system.
Now optimized to use direct functions from document_search_api.py for maximum performance.
"""
    ...
    request={
        'application/json': {
            ...
            'properties': {
                ...
                'agent_mode': {
                    'type': 'string',
                    'description': 'Agent execution mode: "simple" for fastest response, "full" for complete verification',
                    'default': 'simple',
                    'enum': ['simple', 'full']
                }
            },
